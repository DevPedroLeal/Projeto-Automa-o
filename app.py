...
#site pra fazer o lançamento dos dados (https://cadastro-produtos-devaprender.netlify.app/) ficticios
#lembrando que as coordenadas mudam de acordo com a execução, então deve ser alterado essas infos para rodar
#lembrando que deve adaptar de acordo com as informações que vem na planilha
#caso não tenha, abra o CMD e instale o mouseinfo (pip install mouseinfo), seguida rode "python" no CMD e depois "from mouseinfo import mouseInfo", por fim escreva "mouseInfo()" e pegue as coordenadas.
